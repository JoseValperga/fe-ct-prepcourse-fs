...
function filter(arrayOfStrings) {
   ...
   var primeraLetraEsA = function (string) {
      array = string.split('');
      if (array[0] === 'a') {
         return true;
      } else {
   ...
   arrayOfStrings.forEach( (elementoAFiltrar) => {
         if(primeraLetraEsA(elementoAFiltrar)){
            arrayADevolver.push(elementoAFiltrar);
         }
      }
   )
